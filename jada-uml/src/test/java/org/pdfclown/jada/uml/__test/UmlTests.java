/*
  ...
  This file (UmlTests.java) is part of jada-uml module in Jada project
...
import org.pdfclown.jada.core.test.JadaTests;
import org.pdfclown.jada.core.test.assertion.JadaLogCaptor;
import org.pdfclown.jada.uml.UmlConfig;

/**
 * Common utilities for JadaUML unit testing.
 *
 * @author Stefano Chizzolini
 */
public final class UmlTests {
  /**
   ...
   *         {@link JadaTests#mockJadaConfig(JadaLogCaptor)}</li>
  ...
  public static UmlConfig mockUmlConfig(@Nullable JadaLogCaptor logCaptor) {
    ...
    {
      var jadaConfig = JadaTests.mockJadaConfig(logCaptor);
