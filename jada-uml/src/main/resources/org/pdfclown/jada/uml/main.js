          ...
          init: function(options) {
            ...
            $(svg).find("a").click(function() {
              /*
                ...
                the navigation to its target as soon as the SVG is released; to avoid such parasitic
                interaction, in order to navigate there must be a significant delay (500+ ms, whilst
                grab-related event is typically 10- ms) between the end of the last grab and the
                click on the link.
              */
              ...
              mouseup: function() {
                if(document.body.style.cursor === 'grabbing'){
                  /*
                    ...
                    NOTE: Only a significantly long (200+ ms) grab is considered as such; otherwise,
                    it degrades to simple click applicable to SVG link navigation. Consequently, the
                    former (actual grab) is applied a zero delay, whilst the latter (simple click)
                    1,000 ms (for further information, see click event for SVG anchors here above).
                  */
