...
1. **check if the issue has already been reported** — use the [GitHub Issues](https://github.com/pdfclown/jada/issues) search
...
By contributing your code, you agree to license your contribution under the [GNU Lesser General Public License (LGPL) version 3.0](https://github.com/pdfclown/jada/blob/main/LICENSE.txt) (`LGPL-3.0-only`).

By contributing to the documentation, you agree to license your contribution under the [Creative Commons Attribution-ShareAlike 4.0 License](https://github.com/pdfclown/jada/blob/main/LICENSES/CC-BY-SA-4.0.txt) (`CC-BY-SA-4.0`).
