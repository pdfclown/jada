/*
  ...
  This file (SrcFileProcessor.java) is part of jada-core module in Jada project
 ...
 */
public abstract class SrcFileProcessor<T> extends FileProcessor<T> {
  protected SrcFileProcessor(FileSerializer<T> serializer) {
    super(serializer);
  }
}
