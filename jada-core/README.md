...
See <code>[org.pdfclown.jada.core.Jada](https://javadoc.io/doc/org.pdfclown/jada-core/0.3.0/org/pdfclown/jada/core/Jada.html)</code> for usage details — for a complete guide to Jada usage, see [Usage](../docs/usage.md).
